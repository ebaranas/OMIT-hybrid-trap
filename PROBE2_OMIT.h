...
PARAMETER(NPERIOD=20000,NTOT=4,R0=200*1.d-9,&
...
Press=1.e-2,rho=2198.,WK=5.9d6,&
Q=3.d0*1.6d-19,RTRAP=1.d-3/sqrt(2.d0),V0=600.d0,trapfreq=1500.,TEMP=300.,mechfreq=50000.d0,G=1d5)