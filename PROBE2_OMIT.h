...
PARAMETER(NPERIOD=100000,NTOT=4,R0=200*1.d-9,&
...
waist=60.d0*1.d-6,XL=1.3d-2,Finesse=0.4d6,&
!Press=1.e-4,rho=2198.,WK=5.9d6,Pin=2.15d-3,PIN2=0.01*Pin,&
Press=6.e-4,rho=2198.,WK=5.9d6,&
Q=1.d0*1.6d-19,RTRAP=1.d-3/sqrt(2.d0),V0=600.d0,trapfreq=1500.,TEMP=300.,mechfreq=50000.d0,G=1d10)
!Q=3.d0*1.6d-19,RTRAP=1.d-3/sqrt(2.d0),V0=600.d0,trapfreq=1500.,TEMP=300.)